...
The real time is now:  ${realtime}
		...
		gameLoadTT = "Initialization of gamescript, a bit later than pressing Load Button",
...
На карте находится ${towns} города(-ов) и ${industries} предприятия(-й).
...
Реальное время сейчас:  ${realtime}
		...
		["Number of different Towns"] = "Количество разных городов",
...
Количество людей в зданиях должно быть: Все - Видимые - в транспортных средствах]],
		DifTownsCountTT = "Люди могут иметь свои пункты назначения в 1, 2 или 3 разных городах",
